...
@st.cache_resource
def init_connection():
    # Streamlit secrets se single-line JSON string ko load kar rahe hain
...
try:
    ...
    # Agar aapko apni sheet ka data dekhna hai, toh niche wale code ka use kar sakte ho:
    # sheet = gc.open("Aapki_Sheet_Ka_Naam").sheet1
